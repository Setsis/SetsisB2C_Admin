...
gulp.task('watch', function() {
  ...
  gulp.watch([paths.src.lang.files], gulp.series('jsLang','browsersyncReload'));
...
gulp.task('jsLang', function() {
  return gulp
    .src(paths.src.lang.files)
    .pipe(uglify())
    .pipe(gulp.dest(paths.dist.lang.dir));
});
